    ...
    $.ajax({
      ...
      .then(function (response) {
        ...
        response.results.forEach(results => {
          ...
          let title = $("<strong><h5><strong>").text( results.title);
          ...
          newDiv.on("click", function (event) {
            ...
            $.ajax({
              ...
              console.log(response);
              $("#modalH").html("<strong>" + results.title + "<strong>").addClass("text-center");
              document.getElementById('nutInfo').innerHTML = "<strong>Recipe Ingredients<strong>" + response + "<strong>Cooking Instructions<strong>";
              ...
              $.ajax({
                ...
                console.log(response[0].steps.step);
                  ...
                  let image = "https://spoonacular.com/recipeImages/" + id + "-312x231.jpg";
                    ...
                    console.log(step);
                  $("#modalPic").attr("src", image).addClass("float-center");
